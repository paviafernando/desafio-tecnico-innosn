  ...
  return (
    ...
    >
      <div className="mb-4 max-w-xs">
        <label htmlFor="filtro-estado" className="mb-1 block text-sm font-medium text-neutral-700 dark:text-neutral-300">
          Filtrar por estado
        </label>
        <input
          id="filtro-estado"
      ...
      {tramites && tramites.length === 0 && (
        <p className="text-sm text-neutral-500 dark:text-neutral-400">No hay trámites para mostrar.</p>
      )}
            ...
            <tbody>
              {tramites.map((tramite) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-neutral-700 dark:text-neutral-300">{tramite.ciudadanoNombre}</td>
